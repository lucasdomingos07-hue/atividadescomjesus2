        ...
        <div className="flex flex-col space-y-6 text-center md:items-center">
          <div className="space-y-4 text-center">
            ...
            <h2 className="text-lg md:text-xl text-foreground max-w-3xl mx-auto">
              Nessas férias, desperte no seu filho o foco, a curiosidade e a fé que as telas estavam apagando.<br/><strong>+100 atividades bíblicas prontas para imprimir e colorir 🎨</strong>
            </h2>
          </div>
        </div>
